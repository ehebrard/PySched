...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
		\uncover<2->{
		\item Simulated by precedence constraints propagation and the ``orchestra's conductor''
		}
	\end{itemize}
...
\begin{frame}
	...
	\begin{myblock}{Search on the precedence graph}
		\begin{itemize}
			...
			\uncover<4->{
					\begin{itemize}
						\item Disjunctive constraints $\implies$ there is a solution iff there is no negative cycle 
	...
	\frametitle{Conflict directed scheduling \mycite{GrimesHebrard15}}
		...
		\begin{columns}
			...
			\begin{myblock}{IBM CP Optimizer}
				\begin{itemize}
					\item Every algorithm seen here (use Cplex's linear relaxation?)
					\item Alternate large neighborhood search and Failure Directed Search
